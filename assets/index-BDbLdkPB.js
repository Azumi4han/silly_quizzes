...
`,Ar=()=>g(br,{get children(){return[g(xr,{class:"language-picker",get children(){return[wr(),"WaffleLang"]}}),g(vr,{class:"language-menu",get children(){return[["English","🥞","en"],["Suomi","🍯","fi"],["Русский","🥐","ru"]].map(e=>g(Sr,{get selected(){return e[2]===Ve()},onClick:()=>gr(e[2]),get children(){return`${e[0]} ${e[1]}`}}))}})]}});z("div")`
  padding: 0.5rem;
  border-radius: 13px;
  ...
  font-size: 1.5em;
  color: white;
`;var kr=ye("<a href=https://github.com/Azumi4han target=_blank>© 2025 AzumiChan // All artwork is copyrighted. Please do not use, copy, or distribute without permission");const Pr=z("div")`
  display: flex;
  height: 100%;
  padding: 15px;
...
`;function Cr(e){return[g(Pr,{get children(){return[g(Ar,{}),g(qr,{get children(){return e.children}})]}}),g(Er,{get children(){return kr()}})]}var Lr=ye("<h3>Question <!> of "),zr=ye("<div>");const Ce=z("div")`
  text-align: center;
  width: 100%;
  padding: 2rem;
  background: #fff;
